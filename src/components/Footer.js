  ...
  return (
    <footer class="text-black bg-white body-font">
        <div class="container px-5 py-4 mx-auto flex items-center sm:flex-row flex-col">
            ...
            <p class="hidden md:flex text-sm sm:ml-4 sm:pl-4 sm:border-l-2 sm:py-2 sm:mt-0 mt-4"> Goutham —
            <a href="https://twitter.com/knyttneve" class="ml-1 md:flex hidden" rel="noopener noreferrer" target="_blank">@goutham4126@gmail.com</a>
            </p>
