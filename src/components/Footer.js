  ...
  return (
    <footer class="text-white body-font">
        <div class="container px-5 py-4 mx-auto flex items-center sm:flex-row flex-col">
            ...
            <p class="hidden md:flex text-sm text-white sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-400 sm:py-2 sm:mt-0 mt-4">© 2024 Goutham —
            <a href="https://twitter.com/knyttneve" class="text-white ml-1 md:flex hidden" rel="noopener noreferrer" target="_blank">@goutham4126@gmail.com</a>
            </p>
            <div class="flex md:ml-auto justify-center gap-10 sm:mt-0 mt-4">
